...
- Focus: Simplicity, interpretability, and fast inference
...
```bash
git clone https://github.com/ahlaamiito-rgb/naive-bayes-weather.git


cd naive-bayes-weather
...
Ahlam Ahmed Olad
Data Scientist | Graphic Designer | Digital Marketer
